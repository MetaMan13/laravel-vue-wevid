<template>
    ...
    <div class="bg-white w-full px-8 py-8 rounded-md shadow-sm border border-gray-200">
        <div class="flex items-center gap-2">
            <h2 class="text-3xl">Edit video</h2>
            <movie
                :width="28"
                :height="28"
                >
            ...
            <form @submit.prevent="updateVideo">
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="bg-white border border-gray-200 rounded-md hover:shadow-sm hover:bg-gray-50">
                            <div class="flex justify-center">
                                ...
                                <!-- If file is selected -->
                                <div v-if="form.file != null" :class="{ 'hidden' : form.progress }" @dragover.prevent @drop.prevent="appendDragAndDropFile($event)" class="py-6 w-full h-full">
                                    <div class="flex justify-center">
                                        <p>{{ form.file.name }}</p>
                                    </div>
                ...
                <div class="mt-6">
                    <div>
                        ...
                        <button v-show="form.progress" @click="form.cancel()" type="button" class="bg-red-500 hover:bg-red-600 text-white border border-gray-200 w-full py-4 rounded-md mt-4">
                            Cancel
                        </button>
                    </div>
                </div>

            ...
            <form @submit.prevent="storeVideo">
                ...
                <div class="mt-6">
                    <div class="flex flex-col">
                        ...
                        <textarea
                            ...
                            class="border border-gray-200 rounded-md focus:ring-transpatent focus:ring-0 focus:border-gray-300 placeholder-gray-400"
                        ></textarea>
                    </div>
                ...
                <div class="mt-6">
                    <div class="flex flex-col">
                        ...
                        />
                        <div
                            class="bg-white border border-gray-200 rounded-md hover:shadow-sm hover:bg-gray-50"
                        >
                            <div class="flex justify-center">
                                ...
                                >
                                    <div class="flex justify-center">
                                        <upload :height="24" :width="24"></upload>
                                    </div>
                                ...
                                >
                                    <div v-if="videoSource">
                                        <video
                                            ...
                                            class="w-full h-72 border-b border-gray-200 rounded-tl-md rounded-tr-md bg-gray-800"
                                            controls
                                            autoplay
                                            loop
                                        >
                ...
                <div class="mt-6">
                    <div>
                        <div
                            v-if="form.progress"
                            class="bg-gray-600 rounded-md flex flex-col items-center py-4"
                        >
                            <p
                                v-if="form.progress"
                                class="text-gray-300"
